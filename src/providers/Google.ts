  ...
  chat: {
    ...
    models: {
      ...
      'gemini-1.5-flash': {
        ...
        description: `Lightweight, fast and cost-efficient while featuring multimodal reasoning and a breakthrough long context window of up to two million tokens.`,
        group: 'Gemini',
      },
      'gemini-1.5-flash-8b': {
