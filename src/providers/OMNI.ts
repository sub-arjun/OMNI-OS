  ...
  chat: {
    ...
    models: {
      ...
      'meta/llama-3.3-70b-instruct': {
        ...
        jsonModelEnabled: true,
        isDefault: false,
        description: `✨ Powerful multilingual model with excellent performance across many tasks.\n\n📊 For experts: Meta's 70B parameter model supporting English, German, French, Italian, Portuguese, Hindi, Spanish, and Thai. Optimized for dialogue with strong capabilities in health (#9), translation (#9), and programming (#10).`,
        group: 'Open Source' as ChatModelGroup,
      },
    },
  },
