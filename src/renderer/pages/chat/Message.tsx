              ...
              {citedFiles.map((fileName: string, idx: number) => (
                ...
                >
                  <div className="flex items-start">
                    <span className="flex-shrink-0 inline-flex items-center justify-center h-6 w-6 rounded-full bg-amber-100 dark:bg-amber-900 text-amber-600 dark:text-amber-300 mr-2 text-xs font-medium">
                      {idx + 1}
                    </span>
          ...
          <div className="message-citations mt-4">
            ...
            <ul className="pl-4 list-none space-y-2">
              {messageCitations.map((citation: string, idx: number) => (
                ...
                >
                  <div className="flex items-start">
                    <span className="flex-shrink-0 inline-flex items-center justify-center h-6 w-6 rounded-full bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-300 mr-2 text-xs font-medium">
                      {idx + 1}
                    </span>
                    <a 
                      href={citation} 
